...
PLATFORM_HINTS = {
    ...
    "api_server": (
        ...
        "formatting (no asterisks, bullets, headers, code fences), unless the caller requests another output format. "
        "Follow any caller-requested format exactly and never expose private reasoning or provider metadata. Treat "
        "ordinary replies like a conversation, not a document. Keep them brief and natural. File/media delivery: "
        "images referenced as MEDIA:/absolute/path tags "
